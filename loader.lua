...
-- Sleek black UI + fixed remote API loading
...
local COLOR_FIELD_HOVER = Color3.fromRGB(32, 32, 37)
local COLOR_BORDER = Color3.fromRGB(38, 38, 43)
local COLOR_BORDER_BRIGHT = Color3.fromRGB(74, 74, 84)
local COLOR_TEXT = Color3.fromRGB(235, 235, 238)
local COLOR_SUBTEXT = Color3.fromRGB(145, 145, 153)
...
local function notify(titleText, bodyText, duration)
	...
	task.delay(duration or 3, function()
		...
		local tween = TweenService:Create(toast, TweenInfo.new(0.16), {
			GroupTransparency = 1,
		})
...
local function checkTrajectoryApi()
	...
	local predictionData = results[5]
...
toggleButton.MouseEnter:Connect(function()
	...
	TweenService:Create(toggleStroke, TweenInfo.new(0.12), {
...
local function createToggle(parent, initial, onChanged)
	...
	local function setState(nextState, skipCallback)
		...
		TweenService:Create(stroke, TweenInfo.new(0.15), {
			Color = state and COLOR_BORDER_BRIGHT or COLOR_BORDER,
		}):Play()
	...
	hitbox.MouseEnter:Connect(function()
		TweenService:Create(track, TweenInfo.new(0.12), {
			BackgroundColor3 = COLOR_FIELD_HOVER,
		}):Play()
	end)
...
local function buildRow(parent, yOffset, labelText, settingKey, minVal, maxVal)
	...
	field.MouseEnter:Connect(function()
		TweenService:Create(field, TweenInfo.new(0.12), {
			BackgroundColor3 = COLOR_FIELD_HOVER,
		}):Play()
	end)
	...
	field.Focused:Connect(function()
		...
		TweenService:Create(fieldStroke, TweenInfo.new(0.12), {
			Color = COLOR_BORDER_BRIGHT,
		}):Play()
	end)
...
local resetStroke = create("UIStroke", {
	Parent = resetButton,
	Color = COLOR_BORDER,
	Thickness = 1,
})
...
resetButton.MouseEnter:Connect(function()
	...
	TweenService:Create(resetStroke, TweenInfo.new(0.12), {
		Color = COLOR_BORDER_BRIGHT,
	}):Play()
end)
...
--------------------------------------------------------------------------
-- Panel open/close + loader animation
--------------------------------------------------------------------------
